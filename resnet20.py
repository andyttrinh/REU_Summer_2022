...
@register_grad_sampler(adder.adder2d)

def conv3x3(in_planes, out_planes, stride=1):
    " 3x3 convolution with padding "
    # if torch.is_tensor(out_planes): 
    #     print(out_planes.size())
    #     in_planes = out_planes.size()[0]
    #     out_planes = out_planes.size()[1]
    # print("inplanes", in_planes)
    # print("outplanes", out_planes)
